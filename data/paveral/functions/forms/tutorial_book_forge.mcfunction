...
execute as @e[type=item,nbt={Item:{tag:{paveral.tutorial_book_dis: 1b}, Count: 1b}},tag=forming_base,scores={FormingAnimation=119}] at @s run function paveral:forms/tutorial_book_forge.addition
