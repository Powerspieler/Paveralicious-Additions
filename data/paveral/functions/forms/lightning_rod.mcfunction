...
execute as @e[type=item,nbt={Item:{id: "minecraft:trident", Count: 1b}},tag=forming_base,scores={FormingAnimation=1}] at @s run data merge entity @e[type=item,nbt={Item:{id:"minecraft:enchanted_book",Count:1b,tag:{display:{Lore:['{"text":"Enhanced Channeling"}']}}}},sort=nearest,limit=1] {Motion:[0.0,0.0,0.0],NoGravity:1b,PickupDelay:32767,Age:-32768,Tags:["forming"]}
execute as @e[type=item,nbt={Item:{id: "minecraft:trident", Count: 1b}},tag=forming_base,scores={FormingAnimation=119}] at @s run function paveral:forms/lightning_rod.addition
