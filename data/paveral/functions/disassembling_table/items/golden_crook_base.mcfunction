...
execute if score @s DisTableAnim matches 199 run tag @a[distance=..10] add paveral.dis.golden_crook_base
execute if score @s DisTableAnim matches 199 run loot spawn ~ ~ ~ loot paveral:disassemble/golden_crook_base
