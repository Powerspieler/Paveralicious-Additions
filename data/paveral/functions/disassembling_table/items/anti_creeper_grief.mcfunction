...
execute if score @s DisTableAnim matches 199 run advancement grant @a[distance=..10] only paveral:dis_anti_creeper_grief
execute if score @s DisTableAnim matches 199 run tag @a[distance=..10] add paveral.dis.anti_creeper_grief
execute if score @s DisTableAnim matches 199 run loot spawn ~ ~ ~ loot paveral:disassemble/anti_creeper_grief
