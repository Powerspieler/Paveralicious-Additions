...
execute if score @s DisTableAnim matches 199 run tag @a[distance=..10] add paveral.dis.sheepfreeze
execute if score @s DisTableAnim matches 199 run loot spawn ~ ~ ~ loot paveral:disassemble/sheepfreeze
